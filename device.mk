...
ifneq ($(filter aosp_angler% superior_angler%, $(TARGET_PRODUCT)),)
PRODUCT_PROPERTY_OVERRIDES += \
...
$(call inherit-product, vendor/superior/config/phone-xxhdpi-3072-dalvik-heap.mk)
$(call inherit-product, vendor/superior/config/phone-xxhdpi-3072-hwui-memory.mk)
